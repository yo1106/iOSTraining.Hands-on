...
- (void)viewDidLoad
{
    ...
    self.texts = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sampleData" ofType:@"plist"]];
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [self.cellForCalcHeight calculateCellHeightWithText:[self.texts objectAtIndex:indexPath.row]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.bodyLabel.text = [self.texts objectAtIndex:indexPath.row];
//    [cell.bodyLabel sizeToFit];
    NSLog(@"%d:%d", indexPath.row, cell.bodyLabel.lineBreakMode);
    return cell;
}
