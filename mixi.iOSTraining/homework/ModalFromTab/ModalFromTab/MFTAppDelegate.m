...
{
    NSString *modalViewControllerName = @"Second";
    
    NSLog(@"tabIdex:%@", viewController.title);
    if(viewController.title == modalViewControllerName){
        MFTModalViewController *mvc = [[MFTModalViewController alloc] init];
        mvc.title = @"modal view";
        [mvc.navigationController setNavigationBarHidden:NO animated:YES];
